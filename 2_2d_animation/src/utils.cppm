...
export int getRandomRange(int a, int b) { // a, b 포함
...
export void drawSpaceship(glm::fvec2 center, float size, glm::fvec4 color) {
...
export void drawRectWithGlow(float x, float y, float width, float height, glm::fvec4 color,
