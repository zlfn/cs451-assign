...
cl testbed.cpp /EHsc /std:c++17 /D "NDEBUG" /I ..\..\include /Fo"build\\" /Fe"build\testbed.exe" /Fd"build\vc.pdb" /link /LIBPATH:..\..\win-x64-msvc\lib freeglut.lib glew32.lib opengl32.lib
